    ...
    <section id="about" class="relative bg-gradient-to-br from-red-700 via-red-600 to-red-800 text-white overflow-hidden">
        ...
        <div class="container mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
            ...
            <div class="pt-20 pb-16 text-center">
                <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 text-shadow-glow leading-none tracking-tight">
                    Tentang 
            ...
            <div class="max-w-7xl mx-auto mb-20">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                        <div class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl mb-6 flex items-center justify-center">
                        ...
                        <p class="text-red-100 text-sm leading-relaxed">Website modern, responsif, dan user-friendly untuk meningkatkan presence digital Anda</p>
                    </div>
                    ...
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                        ...
                        <p class="text-red-100 text-sm leading-relaxed">Aplikasi iOS dan Android yang powerful dan user-centric untuk menjangkau audience mobile</p>
                    </div>
                    ...
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                        ...
                        <p class="text-red-100 text-sm leading-relaxed">Strategi pemasaran digital yang efektif untuk meningkatkan brand awareness dan konversi</p>
                    </div>
                    ...
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                        ...
                        <p class="text-red-100 text-sm leading-relaxed">Solusi teknologi komprehensif dan konsultasi strategis untuk pertumbuhan bisnis Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto mb-20">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-gradient-to-br from-yellow-400/20 to-orange-500/20 backdrop-blur-lg rounded-2xl p-8 border border-yellow-300/30 shadow-xl text-center">
                        ...
                        <p class="text-red-100 leading-relaxed">Selalu menggunakan teknologi terdepan dan solusi kreatif untuk memberikan hasil yang outstanding</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-yellow-400/20 to-orange-500/20 backdrop-blur-lg rounded-2xl p-8 border border-yellow-300/30 shadow-xl text-center">
                        ...
                        <p class="text-red-100 leading-relaxed">Mengutamakan hasil berkualitas tinggi dengan standar internasional dan perhatian terhadap detail</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-yellow-400/20 to-orange-500/20 backdrop-blur-lg rounded-2xl p-8 border border-yellow-300/30 shadow-xl text-center">
                        ...
                        <p class="text-red-100 leading-relaxed">Bekerja sama dengan klien sebagai partner untuk mencapai kesuksesan bersama</p>
                    </div>
                </div>
            </div>
            ...
            {{-- Stats Section --}}
            <div class="max-w-6xl mx-auto mb-20">
                <div class="bg-gradient-to-br from-orange-500/20 to-red-600/20 backdrop-blur-lg rounded-3xl p-8 lg:p-12 border border-orange-400/30 shadow-2xl">
                    <div class="text-center mb-12">
            ...
            <div class="max-w-6xl mx-auto mb-20">
                <div class="grid md:grid-cols-2 gap-8">
                    <div class="bg-gradient-to-br from-red-600/30 to-red-800/30 backdrop-blur-lg rounded-3xl p-8 lg:p-10 border border-red-500/30 shadow-2xl">
                    ...
                    <div class="bg-gradient-to-br from-orange-600/30 to-red-700/30 backdrop-blur-lg rounded-3xl p-8 lg:p-10 border border-orange-500/30 shadow-2xl">
                        <div class="text-center mb-8">
                            <div class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                                <svg class="w-8 h-8 text-red-900" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="max-w-4xl mx-auto pb-20">
                <div class="bg-gradient-to-r from-yellow-400/20 to-orange-500/20 backdrop-blur-lg rounded-3xl p-8 lg:p-12 border border-yellow-300/30 shadow-2xl text-center">
                    ...
                    <p class="text-red-50 mb-8 text-lg lg:text-xl max-w-2xl mx-auto">
                        Mari wujudkan visi digital Anda bersama tim profesional kami. Konsultasi gratis untuk menentukan solusi terbaik bagi bisnis Anda.
                    </p>
