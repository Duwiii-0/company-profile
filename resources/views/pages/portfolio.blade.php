    ...
    <div class="container mx-auto px-6 py-12 lg:px-8 mt-2 bg-gray-100">
        ...
        <div class="mb-12 animate-slide-up">
            <div class="relative overflow-hidden rounded-2xl p-8 lg:p-12">
                ...
                <div class="relative z-10">
                    <h1
                        class="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-red-700 to-pink-500 bg-clip-text text-transparent animate-gradient-shift">
                        Our Portfolio
                    </h1>
                    <p class="text-gray-600 leading-relaxed max-w-4xl text-lg">
                        We place ourselves on our unwavering commitment to quality and customer satisfaction. We strive to
                        exceed our client's expectations at every step of the way,
        ...
        <div class="mb-12 animate-slide-up" style="animation-delay: 0.2s;">
            ...
            <div class="flex flex-wrap items-center gap-6 mb-8 p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
                ...
                <div class="flex flex-wrap gap-3">
                    @foreach($technologies as $tech)
                        ...
                        : 'bg-gray-100 text-gray-700 hover:bg-gradient-to-r hover:from-red-100 hover:to-pink-100 hover:text-red-600' }}">
                                    ...
                                    @elseif($tech === 'android')
                                        <span class="flex items-center">
                                            <svg class="w-4 h-4 mr-2 transition-transform duration-300 group-hover:bounce"
                                    ...
                                    @elseif($tech === 'ios')
                                        <span class="flex items-center">
                                            <svg class="w-4 h-4 mr-2 transition-transform duration-300 group-hover:pulse"
                                                fill="currentColor" viewBox="0 0 24 24">
                                                <path
                                    ...
                                    @elseif($tech === 'androidtv')
                                        <span class="flex items-center">
                                            <svg class="w-4 h-4 mr-2 transition-transform duration-300 group-hover:scale-110"
                                                fill="currentColor" viewBox="0 0 24 24">
                                                <path
                                                    d="M21 3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h5l-1 1v1h8v-1l-1-1h5c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 12H3V5h18v10z" />
                                            </svg>
                                            AndroidTV
                                        </span>
                                    @endif
                ...
                <button id="reset-filters"
                    class="px-6 py-3 text-sm text-gray-600 hover:text-red-600 transition-all duration-300 hover:scale-105 rounded-xl border border-gray-200 hover:border-red-200 hover:bg-red-50">
                    Reset
                </button>
            </div>
        </div>
        ...
        <div class="relative">
            ...
            <div id="loading-overlay"
                class="absolute inset-0 mt-30 bg-white/90 backdrop-blur-[100px] z-10 flex items-center justify-center rounded-2xl">
            </div>
        </div>
                ...
                <div class="col-span-full text-center py-20 animate-fade-in">
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div
                                class="w-32 h-32 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full animate-pulse opacity-50">
                            </div>
                        </div>
                        <div class="relative z-10">
                            ...
                            <div class="mt-6">
                                <button id="view-all-btn"
                                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-600 to-pink-500 text-white rounded-xl hover:shadow-lg transition-all duration-300 transform hover:scale-105">
